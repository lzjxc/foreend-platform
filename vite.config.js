    ...
    server: {
        ...
        proxy: {
            ...
            '/design-skills-api': {
                ...
                changeOrigin: true,
                rewrite: function (p) { return p.replace(/^\/design-skills-api/, ''); },
            },
